const parkingData = [
  ...
  },
  {
    ...
    name: "Adil's Parking",
    location:
      "Moulama Mohammed Ali Road near Madina Masjid,Babu Bazar,Khidirpur,Kolkata-700023",
    totalSpaces: 100,
    availableSpaces: 50,
    hourlyRate: 60,
    isOpen: true,
  ...
  },
  {
    ...
    location:
      "CSIR-IICB,Indian association for the cultivation of science,Poddar Nagar,Jadavpur,Kolkata-700032",
    totalSpaces: 200,
    availableSpaces: 90,
    hourlyRate: 60,
    isOpen: false,
  ...
  },
  {
    ...
    location:
      "CITY CENTRE 1 DC BLOCK PARKING LOT. SEC 1 KOLKATA 700064, DC Block, Sector 1, Bidhannagar, Kolkata, West Bengal 700064",
    totalSpaces: 300,
    availableSpaces: 200,
    hourlyRate: 80,
    isOpen: false,
  ...
  },
  {
    ...
    name: "Parking Place",
    location:
      "HCMG+HHX, CK Block, Sector II, Bidhannagar, Kolkata, West Bengal 700091",
    totalSpaces: 200,
    availableSpaces: 100,
    hourlyRate: 80,
    isOpen: false,
  ...
  },
  {
    ...
    name: "RKG Garage",
    location:
      "19/62, Mall Rd, K.B.Sarani, Arjunpur, Dum Dum, Kolkata, West Bengal 700080",
    totalSpaces: 300,
    availableSpaces: 200,
    hourlyRate: 60,
    isOpen: false,
  ...
  },
  {
    ...
    location:
      "G9RW+R2J, JBS Haldane Ave, Mirania Gardens, East Topsia, Topsia, Kolkata-700046",
    totalSpaces: 300, //max
    availableSpaces: 150,
  ...
  },
  {
    ...
    location:
      "H9W7+FH6, Sovabazar St, Girish Park, Sovabazar, Darjipara, Kolkata-700006",
    totalSpaces: 150,
    availableSpaces: 40,
    hourlyRate: 65,
    isOpen: true,
  ...
  },
  {
    ...
    location:
      "50B, Muktaram Babu St, Raja Katra, Singhi Bagan, Jorasanko, Kolkata-700007",
    totalSpaces: 250,
    availableSpaces: 100,
    hourlyRate: 60,
    isOpen: false,
  ...
  },
  {
    ...
    name: "Car Park",
    location:
      "3, 63, Aurobindo Sarani Rd, West Kamalapur, Kalidham, Colony, Dum Dum, Kolkata, North Dumdum-700055",
    totalSpaces: 300,
    availableSpaces: 150,
    hourlyRate: 70,
    isOpen: true,
  ...
  },
  {
    ...
    location:
      "4, Deshpran Sasmal Ave, Dunlop, U B Colony, Ashokgarh, Kolkata-700108",
    totalSpaces: 200,
    availableSpaces: 150,
    hourlyRate: 70,
    isOpen: true,
  ...
  },
  {
    ...
    location:
      "375, Prince Anwar Shah Rd, South City Complex, Tollygunge, Kolkata-700068",
    totalSpaces: 300,
    availableSpaces: 200,
    hourlyRate: 80,
    isOpen: true,
  ...
  },
  {
    ...
    name: "S B Garage",
    location:
      "12/C, Lenin Sarani, Barabagan, Serampore, Dakshin Rajyadharpur, West Bengal 71220",
    totalSpaces: 200,
    availableSpaces: 100,
    hourlyRate: 60,
    isOpen: true,
